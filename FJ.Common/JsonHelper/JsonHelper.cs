...
namespace FJ.Common.JsonHelper
{
    /// <summary>
    /// 提供了一个关于json的辅助类
    /// </summary>
    public class JsonHelper
    {
        ...
        {
            return JsonConverter.SerializeObject(t, Newtonsoft.Json.Formatting.Indented, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Include });
        }
        /// <summary>
        /// 类对像转换成json格式
        /// </summary>
